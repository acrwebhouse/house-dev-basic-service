...
function addHouseDev(name,serviceCharge,city,area,owner,address,saleType,source,hostName,hostPhone,hostGender,remark,callback) {
...
function editHouseDev(id,name,serviceCharge,city,area,owner,address,saleType,source,hostName,hostPhone,hostGender,remark, callback) {
    if (id.length == 24){
        const updateData = {
            name,
            serviceCharge,

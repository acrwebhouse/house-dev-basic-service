exports.on = function(app) {
    ...
    app.post(preRestApi + '/addHouseDev', function(req, res) {
        ...
        houseDev.addHouseDev(name,serviceCharge,city,area,owner,address,saleType,source,hostName,hostPhone,hostGender,remark,(result,data)=> {
    ...
    app.put(preRestApi + '/editHouseDev', function(req, res) {
       /*#swagger.parameters['obj'] = {
        ...
        houseDev.editHouseDev(id,name,serviceCharge,city,area,owner,address,saleType,source,hostName,hostPhone,hostGender,remark,(result,data)=> {
            response.status = result;
            response.data = data
            res.send(response);
        })
